...
-- Exportiere Daten aus Tabelle authserverdb.acme_user: ~1 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle authserverdb.authority: ~2 rows (ungefähr)
...
-- Exportiere Daten aus Tabelle authserverdb.user_2_authority: ~1 rows (ungefähr)
