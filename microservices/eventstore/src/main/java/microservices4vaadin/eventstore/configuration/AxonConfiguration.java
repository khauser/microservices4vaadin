package microservices4vaadin.eventstore.configuration;
...
/*    @Bean
    ...
    @Bean
    EventSourcingRepository<UserAggregate> userEventSourcingRepository() {
        EventSourcingRepository<UserAggregate> repo = new EventSourcingRepository<UserAggregate>(UserAggregate.class, eventStore());
        repo.setEventBus(eventBus());

        AggregateAnnotationCommandHandler.subscribe(UserAggregate.class, repo, commandBus());
